...
resource "aws_subnet" "frontend_1a" {
  ...
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_frontend_1a_name : terraform.env == "stg" ? var.stg_vpc_subnet_frontend_1a_name : var.prod_vpc_subnet_frontend_1a_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
...
resource "aws_subnet" "frontend_1c" {
  ...
  map_public_ip_on_launch = true
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_frontend_1c_name : terraform.env == "stg" ? var.stg_vpc_subnet_frontend_1c_name : var.prod_vpc_subnet_frontend_1c_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
...
resource "aws_subnet" "application_1a" {
  ...
  availability_zone = "ap-northeast-1a"
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_application_1a_name : terraform.env == "stg" ? var.stg_vpc_subnet_application_1a_name : var.prod_vpc_subnet_application_1a_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
...
resource "aws_subnet" "application_1c" {
  ...
  availability_zone = "ap-northeast-1c"
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_application_1c_name : terraform.env == "stg" ? var.stg_vpc_subnet_application_1c_name : var.prod_vpc_subnet_application_1c_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
...
resource "aws_subnet" "datastore_1a" {
  ...
  availability_zone = "ap-northeast-1a"
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_datastore_1a_name : terraform.env == "stg" ? var.stg_vpc_subnet_datastore_1a_name : var.prod_vpc_subnet_datastore_1a_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
...
resource "aws_subnet" "datastore_1c" {
  ...
  availability_zone = "ap-northeast-1c"
  tags {
    Name = "${var.prj_name}-${terraform.env}-${terraform.env == "dev" ? var.dev_vpc_subnet_datastore_1c_name : terraform.env == "stg" ? var.stg_vpc_subnet_datastore_1c_name : var.prod_vpc_subnet_datastore_1c_name}"
    env = "${terraform.env}"
    prj = "${var.prj_name}"
  }
}
